...
<div id="container" class="clearfix">
	<div class="mainWidth">
		<div id="header">
			<h1><a href="<?php echo ''.BASE_PATH.''; ?>/"><span>Mobile Website Generator</span></a></h1><div class="beta">BETA</div>
			<ul id="nav">
				<li><a href="<?php echo ''.BASE_PATH.''; ?>/">Home</a></li>
				<li><a href="<?php echo ''.BASE_PATH.''; ?>/about">About</a></li>
				<li><a href="<?php echo ''.BASE_PATH.''; ?>/help">Help & Support</a></li>
				<li class="active"><a href="<?php echo ''.BASE_PATH.''; ?>/contact">Contact</a></li>
			</ul>			
		</div><!-- /header -->		
